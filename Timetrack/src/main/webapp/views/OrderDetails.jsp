...
<title>order detail</title>
 <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
   ...
   <style type="text/css">
   body {
	background-image: url("http://hdwallpaperbackgrounds.net/wp-content/uploads/2015/08/Golden-Clock-HD-Wallpapers.jpg");
...
<body>
	 <h3 style="font-family:monotype corsiva;color:lavender;font-size: 3em;"><b>OrderDetails</b></h3>
<div  ng-app="addToCartApp"  ng-controller = "addToCartCtrl"  ng-init="retrieveCart('${cartId}')">
	 
	 <div >
        <table class="table table-bordered" style="font-family:monotype corsiva;color:white;font-size: 1.5em;" >
		  <thead>
			  <tr>
			  <th>Product</th>
				<th >Unit Price</th>
