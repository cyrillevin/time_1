...
a
{
   ...
   body {
	background-image: url("http://img09.deviantart.net/1251/i/2014/138/8/f/steampunk_watch___timemachine_by_steamworker-d7iu5rq.jpg");
      ...
      <figure class="theCardFront">
    	<div class="instructionsCards">
        	<div class="variousCards"> 
            	<div class="visacardImg"><font color="Lavender"><span><B>Payment details</B></span></font></div>
            </div>
        </div>      	
        <br class="clear" />
        <div class="cardNumber"><font color="Lavender" size="-1">CARD NUMBER</font><br/>
            <input class="firstfour" input placeholder="enter 16 digit code" maxlength="16" />
            
        </div>
        <div class="cardExpiration"><font color="Lavender" size="-1">EXPIRATION</font><br/>
        	<select>
