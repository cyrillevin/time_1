...
body {
	background-image: url("https://lh4.googleusercontent.com/CDOTjUb6IB0ZK5nB-lnLuk2mX99o_an9gP0JIXC9fCTY062XDoOFo9lNnbPVCzAe9QNUnwM0vgmmpkcZ0nng5Td4ZqUegNCAId9_r7CUzk1ZE8aDxLpQLi-3CT9qZ-E5Kw");
...
<body>
	...
	<header>
		<center>
		<h1 style="font-family:Bradley Hand ITC;color:white;"><img src="http://24.media.tumblr.com/tumblr_m2v9ecd8hW1rqfti6o1_500.png " height="70" width="70" style="font-family:" /><b>T!meTraCk</b></h1>
	</center>
...
<div > 
					<h3 style="font-family:Harrington;color:white;font-size: 1.7em;"><b>Items in your cart</b></h3>
					</div>
<div  ng-app="addToCartApp"  ng-controller = "addToCartCtrl"  ng-init="retrieveCart('${cartId}')">
<br>
	 <div >
        <table class="table table-bordered" style="font-family:Bell MT;color:black;font-size:1.5em;" >
		  <thead>
			  <tr>
			  <th>Product</th>
				<th >Unit Price</th>
 ...
 cartApp.controller("addToCartCtrl", function ($scope, $http){
      ...
      */
      $scope.removeItemFromCart = function (id) {
         $http['delete']('http://localhost:8080/Timetrack/categoryDropdown/productDisplay/usercart/cart/removeItem/'+id).success(function (data) {
     ...
     $scope.addItemToCart = function (id) {
         $http.put('http://localhost:8080/Timetrack/usercart/cart/addItem/'+id).success(function (data) {
     ...
     $scope.refreshCartItems = function () {
         $http.get('http://localhost:8080/Timetrack/categoryDropdown/productDisplay/usercart/cart/refreshCart/'+$scope.cartId).success(function (data) {
            $scope.cart=data;
         });
     };
     ...
     $scope.clearCartItems = function () {
     	$http['delete']('http://localhost:8080/Timetrack/categoryDropdown/productDisplay/usercart/cart/clearCartItems/'+$scope.cartId).success(function (data)
     			{$scope.refreshCartItems()
     		});
     };
 });
