...
.background {
	background-image: url("http://media.gq.com/photos/589a7b4e4a441ac67f7644be/master/pass/Todd-Snyder-Timex-watch-01.jpg");
	background-size:100%;
}
...
<br>
	   ...
	   <table  cellspacing="10" cellpadding="2" width="45%" 
			align="center">
<tr>
<td style="color:white;font-weight: bold;font-family: monotype corsiva;font-size: 1.5em;" > UserName<p></td>
<td ><input type="text"  name="username" size="20"/><p></td>
</tr>

<tr>
<td style="color:white;font-weight: bold;font-family: monotype corsiva;font-size: 1.5em;">Password<p></td>
